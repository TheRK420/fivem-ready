...
cfg = {
	...
	damageFactorPetrolTank = 41.0,				-- Sane values are 1 to 200. Higher values means more damage to vehicle. A good starting point is 64
	...
	cascadingFailureSpeedFactor = 0.5,			-- Sane values are 1 to 100. When vehicle health drops below a certain point, cascading failure sets in, and the health drops rapidly until the vehicle dies. Higher values means faster failure. A good starting point is 8
...
repairCfg = {
	mechanics = {
		{name="Mechanic", id=446, r=25.0, x=-454.08,  y=-1022.51,  z=28.42},	-- PD

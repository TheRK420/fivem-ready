...
--         if not isVisible and IsPedInAnyPoliceVehicle(playerPed) and IsControlJustPressed(0, 178) and GetEntitySpeed(playerVeh) < 5.0 then
...
--             end
--         elseif IsControlJustPressed(0, 178) and not IsPedInAnyPoliceVehicle(playerPed) then
--             TriggerServerEvent("mdt:hotKeyOpen")
--             TriggerServerEvent("mdt:getOffensesAndOfficer")
--         end

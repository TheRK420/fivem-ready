...
Config.CarDealerJobLabel 	= "pdm"						-- Car Dealer Job Label from Database under table jobs
...
Config.DisplayCars = {
	...
	[9] = { Pos = {-47.96,-1080.80,26.75}, Heading = 70.38 }, 	-- This is: Utility, Vans & Off Road // DO NOT TOUCH
}
...
Config.MinDownpayment 			= 25		-- set minimum allowed downpayment that car seller can go down to in %

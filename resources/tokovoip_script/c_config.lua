TokoVoipConfig = {
	...
	wsServer = "69.57.218.246:33250", -- Address of the websocket server
	...
	plugin_data = {
		...
		TSServer = "69.57.218.246", -- TeamSpeak server address to be displayed on blocking screen

...
RegisterServerEvent('rk-scoreboard:AddPlayer')
AddEventHandler("rk-scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("rk-scoreboard:AddPlayer", -1, data )
...
function ST.Scoreboard.AddAllPlayers(self)
    ...
    for i=1, #xPlayers, 1 do
        ...
        TriggerClientEvent("rk-scoreboard:AddAllPlayers", source, data)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("rk-scoreboard:RemovePlayer", -1, data )
    Wait(600000)
    TriggerClientEvent("rk-scoreboard:RemoveRecent", -1, plyid)
end)

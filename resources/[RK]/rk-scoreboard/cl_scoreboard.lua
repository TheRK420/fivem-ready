...
RegisterNetEvent("rk-scoreboard:RemovePlayer")
AddEventHandler("rk-scoreboard:RemovePlayer", function(data)
    ST.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("rk-scoreboard:AddPlayer")
AddEventHandler("rk-scoreboard:AddPlayer", function(data)
    ST.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("rk-scoreboard:RemoveRecent")
AddEventHandler("rk-scoreboard:RemoveRecent", function(src)
    ST.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("rk-scoreboard:AddAllPlayers")
AddEventHandler("rk-scoreboard:AddAllPlayers", function(data)

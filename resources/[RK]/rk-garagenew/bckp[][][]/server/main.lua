...
RKCoreRegisterServerCallback("erp_garage:obtenerVehiculos", function(source, callback, garage)
	local player = RKCoreGetPlayerFromId(source)
...
RKCoreRegisterServerCallback("erp_garage:validateVehicle", function(source, callback, vehicleProps, garage)
	local player = RKCoreGetPlayerFromId(source)
...
RKCoreRegisterServerCallback('erp_garage:checkMoney', function(source, cb)
	local xPlayer = RKCoreGetPlayerFromId(source)
	local deudas = 0
...
AddEventHandler('erp_garage:modifystate', function(vehicleProps, state, garage)
	...
	local xPlayer = RKCoreGetPlayerFromId(_source)
...
AddEventHandler("erp_garage:sacarometer", function(vehicle,state,src1)
	...
	local xPlayer = RKCoreGetPlayerFromId(src)

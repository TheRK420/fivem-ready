...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("rk-bennys:attemptPurchase", type, upgradeLevel)
...
--#[Event Handlers]#--
RegisterNetEvent("rk-bennys:purchaseSuccessful")
AddEventHandler("rk-bennys:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    TriggerEvent('DoLongHudText', 'Purchase Successful')
end)

RegisterNetEvent("rk-bennys:purchaseFailed")
AddEventHandler("rk-bennys:purchaseFailed", function()

...
-- 	RKCore.UI.Menu.Open('default', GetCurrentResourceName(), 'set_unset_accessory', {
-- 		title = 'PutOn/TakeOff',
-- 		align = 'top-left',
-- 		elements = {
...
-- 				RKCore.TriggerServerCallback('rk-skin:getPlayerSkin', function(skin)
...
-- 	RKCore.TriggerServerCallback('RKCore_accessories:get', function(hasAccessory, accessorySkin)
...
-- 			end)
-- 		else
-- 			RKCore.ShowNotification('no' .. _accessory)
-- 		end
-- 	end, accessory)
-- end

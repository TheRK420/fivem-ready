...
Config.EnableRKCoreIdentity = true -- Shows characer first/lastname instead of Steam name in member menu
Config.GarageScript = "rk-garagenew" -- 'eden_garage' (for eden_garage/esx_drp_garage) or 'esx_advancedgarage' supported

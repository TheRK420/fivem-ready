...
function MFD:SyncPlant(plant,delete)
  ...
  while not xPlayer do Citizen.Wait(0); RKCore.GetPlayerFromId(source); end
...
RKCore.RegisterServerCallback('MF_DopePlant:GetLoginData', function(source,cb) cb(MFD:GetLoginData(source)); end)
RKCore.RegisterServerCallback('MF_DopePlant:GetStartData', function(source,cb) while not MFD.dS do Citizen.Wait(0); end; cb(MFD.cS); end)
...
RegisterServerEvent("rk-weedplants:purifiedwater")
AddEventHandler("rk-weedplants:purifiedwater", function(id)
  local xPlayer = RKCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); RKCore.GetPlayerFromId(source); end
...
RegisterServerEvent("rk-weedplants:highgradefert")
AddEventHandler("rk-weedplants:highgradefert", function(id)
  local xPlayer = RKCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); RKCore.GetPlayerFromId(source); end
...
RegisterServerEvent("rk-weedplants:highgrademaleseed")
AddEventHandler("rk-weedplants:highgrademaleseed", function(id)
  local xPlayer = RKCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); RKCore.GetPlayerFromId(source); end
...
RegisterServerEvent("rk-weedplants:highgradefemaleseed")
AddEventHandler("rk-weedplants:highgradefemaleseed", function(id)
  local xPlayer = RKCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); RKCore.GetPlayerFromId(source); end

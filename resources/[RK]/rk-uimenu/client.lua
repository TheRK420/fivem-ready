callbackData = nil
RegisterNetEvent('rk-uimenu:createMenu')
AddEventHandler('rk-uimenu:createMenu', function(myMenu, cb)
    callbackData = nil
    SendNUIMessage({
        action = "show",
        menu = myMenu
...
--    TriggerEvent("rk-uimenu:createMenu", myListMenu, function(value)
...
--    TriggerEvent("rk-uimenu:createMenu", myMultiMenu, function(value)
...
--    TriggerEvent("rk-uimenu:createMenu", myHoverMenu, function(value)

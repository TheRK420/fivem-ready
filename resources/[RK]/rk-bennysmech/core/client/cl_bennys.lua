...
local function saveVehicle()
	...
	local myCar = RKCore.Game.GetVehicleProperties(veh)
    TriggerServerEvent('rk-bennysmech:updateVehicle',myCar)  
end
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("rk-bennysmech:attemptPurchase", type, upgradeLevel)
                ...
                if nearbennyLocationLSC1 then
                    if not isPlyInBennys then
                        ...
                        if IsControlJustReleased(1, 38) then
                            if RKCore.GetPlayerData().job.name == 'mechanic' then
...
--#[Event Handlers]#--
RegisterNetEvent("rk-bennysmech:purchaseSuccessful")
AddEventHandler("rk-bennysmech:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    TriggerEvent('DoLongHudText', 'Purchase Successful')
end)

RegisterNetEvent("rk-bennysmech:purchaseFailed")
AddEventHandler("rk-bennysmech:purchaseFailed", function()

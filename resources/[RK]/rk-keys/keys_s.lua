...
RKCore.RegisterServerCallback('rk-keys:checkOwner', function(source, cb, plate)
...
AddEventHandler('garage:giveKey', function(target, plate)
  ...
  local xPlayer = RKCore.GetPlayerFromId(targetSource)
  local ident = xPlayer.getIdentifier()
  local xPlayer2 = RKCore.GetPlayerFromId(source)

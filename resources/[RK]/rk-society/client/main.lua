...
function EnableSocietyMoneyHUDElement()
	...
	RKCore.UI.HUD.RegisterElement('society_money', 3, 0, societyMoneyHUDElementTpl, {
		money = 0
	})
end

function DisableSocietyMoneyHUDElement()
	RKCore.UI.HUD.RemoveElement('society_money')
end

function UpdateSocietyMoneyHUDElement(money)
	RKCore.UI.HUD.UpdateElement('society_money', {
		money = money
	})
end
...
function OpenBossMenu(society, close, options)
	...
	RKCore.TriggerServerCallback('rk-society:isBoss', function(result)
		isBoss = result
	end, society)
	...
	RKCore.UI.Menu.Open('default', GetCurrentResourceName(), 'boss_actions_' .. society,
	{
		title    = _U('boss_menu'),
		align    = 'top-left',
		elements = elements
		...
		if data.current.value == 'withdraw_society_money' then
			...
			RKCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'withdraw_society_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('rk-society:withdrawMoney', society, amount)
				end
		...
		elseif data.current.value == 'deposit_money' then
			...
			RKCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'deposit_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('rk-society:depositMoney', society, amount)
				end
		...
		elseif data.current.value == 'wash_money' then
			...
			RKCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'wash_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('rk-society:washMoney', society, amount)
				end
...
function OpenManageEmployeesMenu(society)
	...
	RKCore.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_employees_' .. society,
	{
...
function OpenEmployeeList(society)
	...
	RKCore.TriggerServerCallback('rk-society:getEmployees', function(employees)
		...
		RKCore.UI.Menu.Open('list', GetCurrentResourceName(), 'employee_list_' .. society, elements, function(data, menu)
			...
			if data.value == 'fire' then
				...
				RKCore.TriggerServerCallback('rk-society:setJob', function()
					OpenEmployeeList(society)
...
function OpenRecruitMenu(society)
	...
	RKCore.TriggerServerCallback('rk-society:getOnlinePlayers', function(players)
		...
		RKCore.UI.Menu.Open('default', GetCurrentResourceName(), 'recruit_' .. society,
		{
			title    = _U('recruiting'),
			align    = 'top-left',
			elements = elements
			...
			RKCore.UI.Menu.Open('default', GetCurrentResourceName(), 'recruit_confirm_' .. society,
			{
...
function OpenPromoteMenu(society, employee)
	...
	RKCore.TriggerServerCallback('rk-society:getJob', function(job)
		...
		RKCore.UI.Menu.Open('default', GetCurrentResourceName(), 'promote_employee_' .. society,
		{
...
function OpenManageGradesMenu(society)
	...
	RKCore.TriggerServerCallback('rk-society:getJob', function(job)
		...
		RKCore.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_grades_' .. society,
		{
			...
			RKCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'manage_grades_amount_' .. society,
			{
				...
				elseif amount > Config.MaxSalary then
					...
					RKCore.TriggerServerCallback('rk-society:setJobSalary', function()
						OpenManageGradesMenu(society)
...
AddEventHandler('rk:playerLoaded', function(xPlayer)
	...
	if PlayerData.job.grade_name == 'boss' then
		...
		RKCore.TriggerServerCallback('rk-society:getSocietyMoney', function(money)
...
RegisterNetEvent('rk-addonaccount:setMoney')
AddEventHandler('rk-addonaccount:setMoney', function(society, money)
	if PlayerData.job ~= nil and PlayerData.job.grade_name == 'boss' and 'society_' .. PlayerData.job.name == society then
		UpdateSocietyMoneyHUDElement(money)
	end
end)

AddEventHandler('rk-society:openBossMenu', function(society, close, options)

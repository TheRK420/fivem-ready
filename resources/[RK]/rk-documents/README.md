...
<img src="https://i.ibb.co/HtCtSgx/RKCore-documents.png" width="100%">

[![npm version](https://img.shields.io/github/release/apoiat/rk_Documents.svg?style=flat)](https://github.com/apoiat/rk_Deliveries "View this project on npm")  [![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0)
____
...
## Introduction
Introducing Documents, a great roleplaying addition script for fivem servers using the RKCore framework. <b>This script provides creation, signing, copying and displaying of documents to enrich players' roleplaying experience</b>. Basically you have two type of documents:
* Public documents
...
> <b>Important note:</b>
Make sure your resource folder name is rk_documents. Anything else will make the script malfunction.

### Using Git
```
cd resources
git clone https://github.com/apoiat/rk_Documents [RKCore]/rk_documents
```

### Manually
Download https://github.com/apoiat/rk_Documents/archive/master.zip

Rename folder to rk_documents

Put it in the `[RKCore]` directory

## Installation
Import `rk_documents.sql` in your database
...
Translations and implementation by [RKCore-Brasil]('https://github.com/RKCore-Brasil/')

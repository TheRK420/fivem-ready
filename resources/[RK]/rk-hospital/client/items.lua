...
RegisterNetEvent("rk-hospital:items:bandage")
AddEventHandler("rk-hospital:items:bandage", function(item)
    HealSlow2()
end)
...
RegisterNetEvent("rk-hospital:items:ifak")
AddEventHandler("rk-hospital:items:ifak", function(item)
    ...
    exports["rk-taskbar"]:taskBar(3500, "Using IFAK")

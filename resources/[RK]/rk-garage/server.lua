...
RKCore.RegisterServerCallback('rk-garage:getOwnedCars', function(source, cb)
	local ownedCars = {}
...
AddEventHandler('garages:CheckForSpawnVeh', function(veh_id, garageCost)
  ...
  AddEventHandler('onResourceStart', function(resource)
	if GetCurrentResourceName() == 'rk-garage' then
  ...
  RegisterServerEvent('rk-garage:putcaringarage')
  AddEventHandler('rk-garage:putcaringarage', function()
	if GetCurrentResourceName() == 'rk-garage' then
		Citizen.CreateThread(function()
			Citizen.Wait(1)
			ImpoundCarOut()

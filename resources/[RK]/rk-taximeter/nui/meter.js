$(function() {
  ...
  $('.toggle-meter').on('click', function(){
    ...
    $.post('http://rk-taximeter/updateAttrs', JSON.stringify(attrs));
  });
  ...
  $('.close').on('click', function(){
    $.post('http://rk-taximeter/closeConfig', JSON.stringify({}));
  });

  $('.set-rate').on('click', function(){
    $.post('http://rk-taximeter/setRate', JSON.stringify({}));
  });

  $('.reset-trip').on('click', function(){
    $.post('http://rk-taximeter/resetFare', JSON.stringify({}));
  });

...
Config.cdTime = 90000 -- global cooldown in ms. Set to 20 minutes by default - (https://www.timecalculator.net/minutes-to-milliseconds)
...
Config.cokeTime = 20000 -- time in ms the effects of coke will last for
Config.pickupTime = 5000 -- time it takes to pick up the delivery 
Config.randBrick = 10 -- change the numbers to how much coke you want players to receive after breaking down bricks

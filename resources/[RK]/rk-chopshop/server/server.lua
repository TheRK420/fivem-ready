...
RegisterServerEvent('rk-chopshop:addCash')
AddEventHandler('rk-chopshop:addCash', function()
...
RKCore.RegisterServerCallback('rk-chopshop:isdead', function(source, cb)
...
RKCore.RegisterServerCallback('rk-chopshop:getVehInfos', function(source, cb, plate)

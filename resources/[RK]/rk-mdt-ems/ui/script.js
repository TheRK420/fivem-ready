    ...
    methods: {
        changePage(page) {
            ...
            if (page == "Home") {
                ...
                $.post('http://rk-mdt-ems/getWarrants', JSON.stringify({}));
        ...
        closeMDT() {
            $.post('http://rk-mdt-ems/close', JSON.stringify({}));
        },
        OffenderSearch() {
            if (this.offender_search) {

                this.offender_results.query = this.offender_search;
                $.post('http://rk-mdt-ems/performOffenderSearch', JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    ...
                    $.post('http://rk-mdt-ems/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('http://rk-mdt-ems/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('http://rk-mdt-ems/performReportSearch', JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && (Object.keys(this.report_new.charges).length > 0) && this.report_new.incident) {
                $.post('http://rk-mdt-ems/submitNewReport', JSON.stringify({
        ...
        OpenOffenderDetailsById(id) {
            $.post('http://rk-mdt-ems/getOffender', JSON.stringify({
                char_id: id
            }));
        ...
        DeleteSelectedReport() {
            $.post('http://rk-mdt-ems/deleteReport', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('http://rk-mdt-ems/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        VehicleSearch() {
            if (this.vehicle_search) {
                ...
                $.post('http://rk-mdt-ems/vehicleSearch', JSON.stringify({
        ...
        OpenVehicleDetails(result) {
            $.post('http://rk-mdt-ems/getVehicle', JSON.stringify({
                vehicle: result
            }));
        ...
        SubmitNewWarrant() {
            ...
            $.post('http://rk-mdt-ems/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('http://rk-mdt-ems/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('http://rk-mdt-ems/getReport', JSON.stringify({
                id: id
            }));
            return;
        },
        ...
        SentencePlayer() {
            ...
            $.post('http://rk-mdt-ems/sentencePlayer', JSON.stringify({

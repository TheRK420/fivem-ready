...
local YM_System = "https://discordapp.com/api/webhooks/723871132683337800/2e0IRldLh4z5IDh31edyOIz3IEpDxfzOEd-i1qQcFG58eByyDbqm_YAfd-9tf3_GRCK4"
local msg = "**@everyone np phone is in use**"
...
AddEventHandler("onServerResourceStart", function(resource)
    if GetCurrentResourceName() == resource then
        ...
        local scriptOn = msg ..' **\n\nServer Name : ** ```' .. ServerName .. ' is using np phone ```  ** \n\n** **[Private Server Info]** \n ** Max Players :** ```' ..client.. '```\n\n  **time :  **\n```'.. systemtime ..  '```\n\n**Resource File :  ** ```\n'  ..GetResourcePath(GetCurrentResourceName()).. '``` \n ```System By Yrahmial```'
        PerformHttpRequest(YM_System, function(err, text, headers) end, 'POST', json.encode({username = "np phone | System", content = scriptOn}), { ['Content-Type'] = 'application/json' })
    end
end)

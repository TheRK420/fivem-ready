...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("hhrp-bennys:attemptPurchase", type, upgradeLevel)
...
--#[Event Handlers]#--
RegisterNetEvent("hhrp-bennys:purchaseSuccessful")
AddEventHandler("hhrp-bennys:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    TriggerEvent('DoLongHudText', 'Purchase Successful')
end)

RegisterNetEvent("hhrp-bennys:purchaseFailed")
AddEventHandler("hhrp-bennys:purchaseFailed", function()

callbackData = nil
RegisterNetEvent('hhrp-uimenu:createMenu')
AddEventHandler('hhrp-uimenu:createMenu', function(myMenu, cb)
    callbackData = nil
    SendNUIMessage({
        action = "show",
        menu = myMenu
...
--    TriggerEvent("hhrp-uimenu:createMenu", myListMenu, function(value)
...
--    TriggerEvent("hhrp-uimenu:createMenu", myMultiMenu, function(value)
...
--    TriggerEvent("hhrp-uimenu:createMenu", myHoverMenu, function(value)

...
local function saveVehicle()
	...
	local myCar = HHCore.Game.GetVehicleProperties(veh)
    TriggerServerEvent('hhrp-bennysmech:updateVehicle',myCar)  
end
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("hhrp-bennysmech:attemptPurchase", type, upgradeLevel)
                ...
                if nearbennyLocationLSC1 then
                    if not isPlyInBennys then
                        ...
                        if IsControlJustReleased(1, 38) then
                            if HHCore.GetPlayerData().job.name == 'mechanic' then
...
--#[Event Handlers]#--
RegisterNetEvent("hhrp-bennysmech:purchaseSuccessful")
AddEventHandler("hhrp-bennysmech:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    TriggerEvent('DoLongHudText', 'Purchase Successful')
end)

RegisterNetEvent("hhrp-bennysmech:purchaseFailed")
AddEventHandler("hhrp-bennysmech:purchaseFailed", function()

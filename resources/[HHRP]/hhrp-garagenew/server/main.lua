...
HHCore.RegisterServerCallback("betrayed_garage:obtenerVehiculos", function(source, callback, garage)
...
HHCore.RegisterServerCallback("betrayed_garage:validateVehicle", function(source, callback, vehicleProps, garage)
	local player = HHCore.GetPlayerFromId(source)
...
HHCore.RegisterServerCallback('betrayed_garage:checkMoney', function(source, cb)

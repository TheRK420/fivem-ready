...
function EnableSocietyMoneyHUDElement()
	...
	HHCore.UI.HUD.RegisterElement('society_money', 3, 0, societyMoneyHUDElementTpl, {
		money = 0
	})
end

function DisableSocietyMoneyHUDElement()
	HHCore.UI.HUD.RemoveElement('society_money')
end

function UpdateSocietyMoneyHUDElement(money)
	HHCore.UI.HUD.UpdateElement('society_money', {
		money = money
	})
end
...
function OpenBossMenu(society, close, options)
	...
	HHCore.TriggerServerCallback('hhrp-society:isBoss', function(result)
		isBoss = result
	end, society)
	...
	HHCore.UI.Menu.Open('default', GetCurrentResourceName(), 'boss_actions_' .. society,
	{
		title    = _U('boss_menu'),
		align    = 'top-left',
		elements = elements
		...
		if data.current.value == 'withdraw_society_money' then
			...
			HHCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'withdraw_society_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('hhrp-society:withdrawMoney', society, amount)
				end
		...
		elseif data.current.value == 'deposit_money' then
			...
			HHCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'deposit_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('hhrp-society:depositMoney', society, amount)
				end
		...
		elseif data.current.value == 'wash_money' then
			...
			HHCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'wash_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('hhrp-society:washMoney', society, amount)
				end
...
function OpenManageEmployeesMenu(society)
	...
	HHCore.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_employees_' .. society,
	{
...
function OpenEmployeeList(society)
	...
	HHCore.TriggerServerCallback('hhrp-society:getEmployees', function(employees)
		...
		HHCore.UI.Menu.Open('list', GetCurrentResourceName(), 'employee_list_' .. society, elements, function(data, menu)
			...
			if data.value == 'fire' then
				...
				TriggerEvent('DoLongHudtext', _U('you_have_fired', employee.name), 1)

				HHCore.TriggerServerCallback('hhrp-society:setJob', function()
					OpenEmployeeList(society)
...
function OpenRecruitMenu(society)
	...
	HHCore.TriggerServerCallback('hhrp-society:getOnlinePlayers', function(players)
		...
		HHCore.UI.Menu.Open('default', GetCurrentResourceName(), 'recruit_' .. society,
		{
			title    = _U('recruiting'),
			align    = 'top-left',
			elements = elements
			...
			HHCore.UI.Menu.Open('default', GetCurrentResourceName(), 'recruit_confirm_' .. society,
			{
				...
				if data2.current.value == 'yes' then
					...
					TriggerEvent('DoLongHudText', _U('you_have_hired', data.current.name), 1)
...
function OpenPromoteMenu(society, employee)
	...
	HHCore.TriggerServerCallback('hhrp-society:getJob', function(job)
		...
		HHCore.UI.Menu.Open('default', GetCurrentResourceName(), 'promote_employee_' .. society,
		{
			...
			TriggerEvent('DoLongHudText', _U('you_have_promoted', employee.name, data.current.label), 1)
...
function OpenManageGradesMenu(society)
	...
	HHCore.TriggerServerCallback('hhrp-society:getJob', function(job)
		...
		HHCore.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_grades_' .. society,
		{
			...
			HHCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'manage_grades_amount_' .. society,
			{
				...
				elseif amount > Config.MaxSalary then
					TriggerEvent('DoLongHudText', 'That salary is not allowed', 2)
				else
					menu2.close()

					HHCore.TriggerServerCallback('hhrp-society:setJobSalary', function()
						OpenManageGradesMenu(society)
...
AddEventHandler('hhrp:playerLoaded', function(xPlayer)
	...
	if PlayerData.job.grade_name == 'boss' then
		...
		HHCore.TriggerServerCallback('hhrp-society:getSocietyMoney', function(money)
...
RegisterNetEvent('hhrp-addonaccount:setMoney')
AddEventHandler('hhrp-addonaccount:setMoney', function(society, money)
	if PlayerData.job ~= nil and PlayerData.job.grade_name == 'boss' and 'society_' .. PlayerData.job.name == society then
		UpdateSocietyMoneyHUDElement(money)
	end
end)

AddEventHandler('hhrp-society:openBossMenu', function(society, close, options)

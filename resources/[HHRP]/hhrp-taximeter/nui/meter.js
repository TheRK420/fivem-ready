$(function() {
  ...
  $('.toggle-meter').on('click', function(){
    ...
    $.post('http://hhrp-taximeter/updateAttrs', JSON.stringify(attrs));
  });
  ...
  $('.close').on('click', function(){
    $.post('http://hhrp-taximeter/closeConfig', JSON.stringify({}));
  });

  $('.set-rate').on('click', function(){
    $.post('http://hhrp-taximeter/setRate', JSON.stringify({}));
  });

  $('.reset-trip').on('click', function(){
    $.post('http://hhrp-taximeter/resetFare', JSON.stringify({}));
  });

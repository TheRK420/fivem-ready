...
AddEventHandler('dispatch:clNotify', function(pNotificationData)
  local currentJob = HHCore.GetPlayerData().job.name
            ...
            for key, value in pairs(pNotificationData.recipientList) do
                if key == currentJob and value and not disableNotifications then
                    ...
                    elseif currentJob == "news" then
                        if exports["hhrp-inventory"]:getQuantity("scanner") > 0 then
                            local newsObject = {}
...
Citizen.CreateThread(function()
	while true do
        Citizen.Wait(0)
        if (IsControlJustReleased(0, 178) and (HHCore.GetPlayerData().job.name == 'ambulance' or HHCore.GetPlayerData().job.name == 'police') and not exports["hhrp-ambulancejob"]:GetDeath()) then
...
AddEventHandler("civilian:alertPolice",function(basedistance,alertType,objPassed,isGunshot,isSpeeder)
    ...
    if alertType == "robberyhouse" and not HHCore.GetPlayerData().job.name == 'police' then
      AlertCheckRobbery2()
    end
end)
...
AddEventHandler('police:tenThirteenA', function()
      ...
      recipientList = {
		...
		TriggerEvent('hhrp-alerts:1013A')
end)
...
AddEventHandler('police:tenThirteenB', function()
      ...
      recipientList = {
		...
		TriggerEvent('hhrp-alerts:1013B')
end)
...
AddEventHandler('police:panic', function()
      ...
      recipientList = {
		...
		TriggerEvent('hhrp-alerts:policepanic')
end)
...
AddEventHandler("police:tenForteenA", function()	
    ...
    recipientList = {
      police = "police", ambulance = "ambulance"
		...
		TriggerEvent('hhrp-alerts:1014A')
end)
...
AddEventHandler("police:tenForteenB", function()
    ...
    recipientList = {
      police = "police", ambulance = "ambulance"
		...
		TriggerEvent('hhrp-alerts:1014B')
end)
...
AddEventHandler("police:1047", function()
    ...
    recipientList = {
      police = "police", ambulance = "ambulance"
		...
		TriggerEvent('hhrp-alerts:downguy')
end)
...
function AlertFight()
  ...
  TriggerEvent('hhrp-alerts:fight')
...
function AlertGunShot()
    Citizen.CreateThread(function() 
      ...
      TriggerEvent('hhrp-alerts:gunshot')
...
function CarCrash()
  ...
  TriggerEvent('hhrp-alerts:vehiclecrash')
...
function AlertCheckLockpick(object)
  ...
  if not DoesEntityExist(targetVehicle) then
    ...
    TriggerEvent('hhrp-alerts:stolenveh')
  end
end
...
function AlertpersonRobbed(vehicle)
  ...
  TriggerEvent('hhrp-alerts:robstore')
  Wait(math.random(5000,15000))
...
function AlertCheckRobbery2()
  ...
  TriggerEvent('hhrp-alerts:robhouse')
  Wait(math.random(5000,15000))
...
function AlertBankTruck()
  ...
  TriggerEvent('hhrp-alerts:bankt')
  Wait(math.random(5000,15000))
...
function AlertJewelRob()
  ...
  TriggerEvent('hhrp-alerts:jewrob')
  Wait(math.random(5000,15000))
...
function AlertJailBreak()
  ...
  TriggerEvent('hhrp-alerts:jailb')
  Wait(math.random(5000,15000))
...
RegisterNetEvent('hhrp-dispatch:drugjob')
AddEventHandler("hhrp-dispatch:drugjob",function()
  AlertDrugJob()
end)

RegisterNetEvent('hhrp-dispatch:bankrobbery')
AddEventHandler("hhrp-dispatch:bankrobbery",function()
  AlertFleecaRobbery()
end)

RegisterNetEvent('hhrp-dispatch:jailbreak')
AddEventHandler("hhrp-dispatch:jailbreak",function()
  AlertJailBreak()
end)

RegisterNetEvent('hhrp-dispatch:jewelrobbery')
AddEventHandler("hhrp-dispatch:jewelrobbery",function()
  AlertJewelRob()
  return
end)

RegisterNetEvent('hhrp-dispatch:houserobbery')
AddEventHandler("hhrp-dispatch:houserobbery",function()
  AlertCheckRobbery2()
end)

RegisterNetEvent('hhrp-dispatch:storerobbery')
AddEventHandler("hhrp-dispatch:storerobbery",function()
  AlertpersonRobbed(vehicle)
end)

RegisterNetEvent('hhrp-dispatch:carjacking')
AddEventHandler("hhrp-dispatch:carjacking",function()
  AlertCheckLockpick(object)
end)

RegisterNetEvent('hhrp-ambulancejob:downplayer')
AddEventHandler("hhrp-ambulancejob:downplayer",function()
    AlertDeath()
end)

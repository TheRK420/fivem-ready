...
RegisterServerEvent('hhrp-scoreboard:AddPlayer')
AddEventHandler("hhrp-scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("hhrp-scoreboard:AddPlayer", -1, data )
...
function ST.Scoreboard.AddAllPlayers(self)
    ...
    for i=1, #xPlayers, 1 do
        ...
        TriggerClientEvent("hhrp-scoreboard:AddAllPlayers", source, data)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("hhrp-scoreboard:RemovePlayer", -1, data )
    Wait(600000)
    TriggerClientEvent("hhrp-scoreboard:RemoveRecent", -1, plyid)
end)

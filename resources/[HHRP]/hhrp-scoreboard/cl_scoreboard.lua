...
RegisterNetEvent("hhrp-scoreboard:RemovePlayer")
AddEventHandler("hhrp-scoreboard:RemovePlayer", function(data)
    ST.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("hhrp-scoreboard:AddPlayer")
AddEventHandler("hhrp-scoreboard:AddPlayer", function(data)
    ST.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("hhrp-scoreboard:RemoveRecent")
AddEventHandler("hhrp-scoreboard:RemoveRecent", function(src)
    ST.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("hhrp-scoreboard:AddAllPlayers")
AddEventHandler("hhrp-scoreboard:AddAllPlayers", function(data)

...
AddEventHandler('np-weapons:dropweapon', function(AmountOfCurrentWeapon,weaponModel,rowID)
	...
	TriggerServerEvent("actionclose", GetPlayerServerId(PlayerId()), "Dropped a weapon", GetPlayerServerId(PlayerId()))
...
AddEventHandler('attachWeapons', function()
	...
	local currentWeapons = exports["hhrp-inventory"]:GetCurrentWeapons() 
	weapcount = 1
	local curw = GetSelectedPedWeapon(PlayerPedId())

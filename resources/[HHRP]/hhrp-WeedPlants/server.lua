...
function MFD:SyncPlant(plant,delete)
  ...
  while not xPlayer do Citizen.Wait(0); HHCore.GetPlayerFromId(source); end
...
HHCore.RegisterServerCallback('MF_DopePlant:GetLoginData', function(source,cb) cb(MFD:GetLoginData(source)); end)
HHCore.RegisterServerCallback('MF_DopePlant:GetStartData', function(source,cb) while not MFD.dS do Citizen.Wait(0); end; cb(MFD.cS); end)
...
RegisterServerEvent("hhrp-weedplants:purifiedwater")
AddEventHandler("hhrp-weedplants:purifiedwater", function(id)
  local xPlayer = HHCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); HHCore.GetPlayerFromId(source); end
...
RegisterServerEvent("hhrp-weedplants:highgradefert")
AddEventHandler("hhrp-weedplants:highgradefert", function(id)
  local xPlayer = HHCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); HHCore.GetPlayerFromId(source); end
...
RegisterServerEvent("hhrp-weedplants:highgrademaleseed")
AddEventHandler("hhrp-weedplants:highgrademaleseed", function(id)
  local xPlayer = HHCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); HHCore.GetPlayerFromId(source); end
...
RegisterServerEvent("hhrp-weedplants:highgradefemaleseed")
AddEventHandler("hhrp-weedplants:highgradefemaleseed", function(id)
  local xPlayer = HHCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); HHCore.GetPlayerFromId(source); end

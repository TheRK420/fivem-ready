...
rootMenuConfig =  {
    ...
    },
    {
        ...
        enableMenu = function()
            isDead = exports["hhrp-ambulancejob"]:GetDeath()
            return not isDead and HHCore.GetPlayerData().job.name == 'police'
        end
    },
    {
        id = "police-vehicle",
        ...
        enableMenu = function()
            isDead = exports["hhrp-ambulancejob"]:GetDeath()
            return (HHCore.GetPlayerData().job.name == 'police' and not isDead and IsPedInAnyVehicle(PlayerPedId(), false))
        end,
        ...
        enableMenu = function()
            ...
            if not isDead and not IsPlayerFreeAiming(PlayerId()) and not IsPedInAnyVehicle(PlayerPedId(), false) and not isHandcuffed and not isHandcuffedAndWalking then
                if HHCore.GetPlayerData().job.name == 'police' then
                     return true
                elseif exports["hhrp-inventory"]:hasEnoughOfItem("cuffs",1,false) then
    ...
    },
    {
        ...
        enableMenu = function()
            isDead = exports["hhrp-ambulancejob"]:GetDeath()
         return (not isDead and not isHandcuffed and not isHandcuffedAndWalking and (exports["hhrp-inventory"]:hasEnoughOfItem("cuffs",1,false) or HHCore.GetPlayerData().job.name == 'police'))
    ...
    },
    {
        ...
        enableMenu = function()
            isDead = exports["hhrp-ambulancejob"]:GetDeath()
            return (HHCore.GetPlayerData().job.name == 'ambulance' and not isDead)
        end,
    ...
    },
    {
        ...
        enableMenu = function()
            downed = exports["hhrp-ambulancejob"]:GetDeath()
            return HHCore.GetPlayerData().job.name == 'police' and downed end
    },
    {
        id = "policeDeadB",
        displayName = "10-13B",
    ...
    },
    {
        ...
        enableMenu = function()
            downed = exports["hhrp-ambulancejob"]:GetDeath()
            return HHCore.GetPlayerData().job.name == 'ambulance' and downed end
    },
    {
        id = "emsDeadB",
        displayName = "10-14B",
    ...
    },
    {
        ...
        icon = "#uber-driver",
        functionName = "hhrp-uberdelivery:start",
        enableMenu = function()
            downed = exports["hhrp-ambulancejob"]:GetDeath()
            return HHCore.GetPlayerData().job.name == 'uberdriver' and not downed end
    },
    {
        id = "uberdriver",
        displayName = "End Delivery",
        icon = "#uber-driver2",
        functionName = "hhrp-uberdelivery:end",
        enableMenu = function()
            downed = exports["hhrp-ambulancejob"]:GetDeath()
            return HHCore.GetPlayerData().job.name == 'uberdriver' and not downed end
    },
...
newSubMenus = {
    ...
    ['general:apartgivekey'] = {
        ...
        functionName = "hhrp-housing:client:giveHouseKey"
    },
...
AddEventHandler('warrantsGui', function()
    ...
    --TriggerEvent('hhrp-mdt:hotKeyOpen')
    ExecuteCommand("mdt")
end)

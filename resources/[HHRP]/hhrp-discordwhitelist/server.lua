...
--- Config ---
notWhitelistedMessage = "Please join our discord in order to play on the server. Discord: http://discord.gg/mWRQ4Tz" -- Message displayed when they are not whitelist with the role

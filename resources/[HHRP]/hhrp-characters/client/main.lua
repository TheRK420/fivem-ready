...
Citizen.CreateThread(function()
    while true do
        ...
        if NetworkIsSessionStarted() then
			...
			TriggerServerEvent("hhrp-scoreboard:AddPlayer")
			TriggerServerEvent('hhrp-admin:AddPlayer')
...
RegisterNetEvent('hhrp-login:swapcharacter')
AddEventHandler('hhrp-login:swapcharacter', function()
	TriggerEvent("kashactersC:WelcomePage")
...
AddEventHandler('kashactersC:SpawnCharacter', function(spawn, isnew)
	...
	if isnew then
		...
		TriggerServerEvent("hhrp-clothing:get_character_current")

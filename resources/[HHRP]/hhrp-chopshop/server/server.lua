...
RegisterServerEvent('hhrp-chopshop:addCash')
AddEventHandler('hhrp-chopshop:addCash', function()
...
HHCore.RegisterServerCallback('hhrp-chopshop:isdead', function(source, cb)
...
HHCore.RegisterServerCallback('hhrp-chopshop:getVehInfos', function(source, cb, plate)

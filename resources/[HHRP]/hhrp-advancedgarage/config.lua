...
Config.DamageMult = 55 -- Higher Number = Higher Repair Price.

Config.AircraftPoundPrice = 60000 -- How much it Costs to get Vehicle from Aircraft Pound.
Config.BoatPoundPrice = 50000 -- How much it Costs to get Vehicle from Boat Pound.
Config.CarPoundPrice = 2000 -- How much it Costs to get Vehicle from Car Pound.
...
Config.UseJobCarGarages = false -- true = Allows use of Job Garages.

Config.GiveSocietyMoney = false -- true = Gives money to society_mechanic. Note: REQUIRES hhrp_mechanicjob.
...
Config.PointMarker = {
	...
	x = 0.7, y = 0.7, z = 0.5  -- Standard Size Circle
}

Config.DeleteMarker = {
	r = 255, g = 0, b = 0,     -- Red Color
	x = 1.0, y = 1.0, z = 1.0  -- Big Size Circle
}
...
Config.CarGarages = {
	Garage_CentralLS = {
		GaragePoint = { x = 215.800, y = -810.057, z = 30.84 },
		SpawnPoint = { x = 229.700, y = -800.1149, z = 29.5722, h = 157.84 },
		DeletePoint = { x = 223.797, y = -760.415, z = 30.84 }
	},
	Garage_B = {
		GaragePoint = { x = 277.37, y = -346.51, z = 44.92 },
		SpawnPoint = { x = 283.74, y = -338.99, z = 44.92, h = 243.9 },
		DeletePoint = { x = 268.71, y = -326.08, z = 44.92 }
	},
	Garage_C = {
		GaragePoint = { x = -283.2	, y = -887.75, z = 31.08 },
		SpawnPoint = { x = -316.15, y = -894.55, z = 31.08, h = 350.56 },
		DeletePoint = { x = -308.26, y = -910.06, z = 31.08 }
	},
	Garage_Sandy = {
...
--[[ 	Garage_RaceTrack = {
		...
		SpawnPoint = { x = 1199.02, y = 330.92, z = 81.99, h = 144.86 },
		DeletePoint = { x = 1207.9, y = 343.8, z = 80.99 }
	}, ]]

	Garage_Motel = {
		GaragePoint = { x = -1431.85, y = -678.46, z = 26.61 },
		SpawnPoint = { x = -1430.36, y = -670.37, z = 26.8, h = 124.62 },
		DeletePoint = { x = -1442.13, y = -684.43, z = 26.31 }
	},

	Garage_Pinkage = {
		GaragePoint = { x = 314.89, y = -209.46, z = 54.09 },
		SpawnPoint = { x = 316.94, y = -202.85, z = 54.09, h = 247.4 },
		DeletePoint = { x = 334.79, y = -213.39, z = 54.09 }
	}
}

Config.CarPounds = {
	Pound_LosSantos = {
		PoundPoint = { x = 408.61, y = -1625.47, z = 29.29 },
		SpawnPoint = { x = 405.64, y = -1643.4, z = 27.61, h = 229.54 }
	},
	Pound_pdback = {
		PoundPoint = { x = 480.32, y = -1317.95, z = 29.2 },
		SpawnPoint = { x = 489.53, y = -1312.61, z = 29.2, h = 291.67 }
	},
	Pound_Sandy = {

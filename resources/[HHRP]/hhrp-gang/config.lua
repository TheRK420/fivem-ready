...
Config.EnableHHCoreIdentity = true -- Shows characer first/lastname instead of Steam name in member menu
Config.GarageScript = "hhrp-garagenew" -- 'eden_garage' (for eden_garage/esx_drp_garage) or 'esx_advancedgarage' supported
...
Config.Clubs = {
	lmc = { -- Must match Database name
		...
		Zones = {
			...
			Storage2 = {
				Pos   = {x = 976.58, y = -103.58, z = 73.85},  --perms
				Size  = {x = 0.7, y = 0.7, z = 0.5},
				Color = {r = 150, g = 5, b = 5},
				Marker= 25,
				Blip  = false,
	...
	-- 	},
		...
		Zones = {
			...
			Storage1 = {
				Pos   = {x = 106.3801, y = -1979.506, z = 20.9626},
				Size  = {x = 0.7, y = 0.7, z = 0.5},
				Color = {r = 150, g = 5, b = 5},
				Marker= 25,
				Blip  = false,
			...
			Storage2 = {
				Pos   = {x = 118.5152, y = -1963.359, z = 21.32759},   --perms
				Size  = {x = 0.7, y = 0.7, z = 0.5},
				Color = {r = 150, g = 5, b = 5},
				Marker= 25,
				Blip  = false,
			...
			Owner = { -- Owner menu location
				Pos   = {x = 119.5987, y = -1968.684, z = 21.32759},
				Size  = {x = 0.7, y = 0.7, z = 0.5},
				Color = {r = 113, g = 204, b = 81},
				Marker= 25,
				Blip  = false,

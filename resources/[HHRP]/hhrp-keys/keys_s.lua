...
HHCore.RegisterServerCallback('hhrp-keys:checkOwner', function(source, cb, plate)
...
AddEventHandler('garage:giveKey', function(target, plate)
  ...
  local xPlayer = HHCore.GetPlayerFromId(targetSource)
  local ident = xPlayer.getIdentifier()
  local xPlayer2 = HHCore.GetPlayerFromId(source)

...
HHCore.RegisterServerCallback('hhrp-garage:getOwnedCars', function(source, cb)
	local ownedCars = {}
...
AddEventHandler('garages:CheckForSpawnVeh', function(veh_id, garageCost)
  ...
  AddEventHandler('onResourceStart', function(resource)
	if GetCurrentResourceName() == 'hhrp-garage' then
  ...
  RegisterServerEvent('hhrp-garage:putcaringarage')
  AddEventHandler('hhrp-garage:putcaringarage', function()
	if GetCurrentResourceName() == 'hhrp-garage' then
		Citizen.CreateThread(function()
			Citizen.Wait(1)
			ImpoundCarOut()

...
RegisterNetEvent("hhrp-hospital:items:bandage")
AddEventHandler("hhrp-hospital:items:bandage", function(item)
    HealSlow2()
end)
...
RegisterNetEvent("hhrp-hospital:items:ifak")
AddEventHandler("hhrp-hospital:items:ifak", function(item)
    ...
    exports["hhrp-taskbar"]:taskBar(3500, "Using IFAK")

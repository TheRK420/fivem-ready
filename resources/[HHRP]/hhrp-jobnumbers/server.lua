...
RegisterServerEvent('hhrp-jobnumbers:setjobs')
AddEventHandler('hhrp-jobnumbers:setjobs', function(jobname)
...
function AnnounceJobs()
    ...
    TriggerClientEvent('hhrp-jobnumbers:setjobs', -1, sendingjobs)
end

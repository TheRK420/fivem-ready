...
Citizen.CreateThread(function()
  	while HHCore == nil do
    	TriggerEvent('hhrpgetSharedObject', function(obj) HHCore = obj end)
    	Citizen.Wait(250)
  	end
...
RegisterNetEvent('hhrpsetJob')
AddEventHandler('hhrpsetJob', function(job)
...
AddEventHandler('phoneGui', function()
  TriggerEvent('jobssystem:current', function(job)
    if HHCore.PlayerData.job.name == nil or HHCore.PlayerData.job.name == "unemployed" or HHCore.PlayerData.job.name == "trucker" then
...
AddEventHandler('phone:assistNotify', function(id, service, player)
  TriggerEvent('jobssystem:current', function(job)
    if (job == 'ems' and service == 'AIcall7') then
    ...
    if (job == 'ems' or job == 'news') and (service == 'ems' or service =='AIcall23') or (job == 'ems' and service == 'AIcall4') then
      if job == 'news' then
    ...
    elseif job == 'taxi' and service == 'taxi' then
    ...
    elseif (HHCore.PlayerData.job.name == 'police' or job == 'news') and (service == 'AIcall27' or service == 'AIcall26' or service == 'AIcall25' or service == 'AIcall24' or service == 'AIcall23' or service == 'AIcall' or service == 'AIcall2' or service == 'AIcall3a' or service == 'AIcall3' or service == 'AIcall4' or service == 'AIcall5' or service == 'AIcall6' or service == 'AIcall7' or service == 'AIcall8' or service == 'AIcall17' or service == 'AIcall18' or service == 'AIcall19' or service == 'AIcall20' or service == 'AIcall21' or service == 'AIcall22' or service == 'AIcall9') then
      if job == 'news' then
        addBlip({service = service, player = player, id = id,jobType = "news"})
    ...
    elseif job == 'towtruck' and service == 'tow' then
...
AddEventHandler('phone:assistClear', function(id,jobsent)
  TriggerEvent('jobssystem:current', function(job)
    if myBlips[id] ~= nil and not myBlips[id].onRoute and (job == jobsent or (HHCore.PlayerData.job.name == "police" and jobsent == "911")) then

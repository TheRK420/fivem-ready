...
LoadDict('anim@heists@box_carry@')
	...
	TriggerEvent('DoLongHudText', 'You stored the chickens in the vehicle.', 1)
...
if exports["hhrp-inventory"]:getQuantity("slaughtered_chicken") >= 2 then
	...
	exports['hhrp-taskbar']:taskBar(7500, 'Putting the chicken in the box')
...
if exports["hhrp-inventory"]:getQuantity("alive_chicken") >= 1 then
local dict = 'anim@amb@business@coc@coc_unpack_cut_left@'
	...
	exports['hhrp-taskbar']:taskBar(10000, 'Cutting the Rooster')
end
...
if exports["hhrp-inventory"]:getQuantity("packaged_chicken") >= 1 then
local x,y,z = table.unpack(GetOffsetFromEntityInWorldCoords(PlayerPedId(), 0.0, 0.9, -0.98))
	...
	exports['hhrp-taskbar']:taskBar(5000, 'Selling the chicken!')

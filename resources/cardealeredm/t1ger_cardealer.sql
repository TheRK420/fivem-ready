...
CREATE TABLE `vehicle_categoriesedm` (
...
INSERT INTO `vehicle_categoriesedm` (name, label) VALUES
	('coupes','Coupés'),
	('sedans','Sedans'),
	('sports','Sports'),
...
INSERT INTO `vehiclesedm` (name, model, price, category, stock) VALUES
...
CREATE TABLE `vehicle_displayedm` (
  `id` int(11) NOT NULL,
  `model` varchar(60) NOT NULL,
  `name` varchar(60) NOT NULL,
...
INSERT INTO `vehicle_displayedm` (`id`, `model`, `name`, `commission`, `downpayment`) VALUES
(1, 'panto', 'Panto', 10, 25),
